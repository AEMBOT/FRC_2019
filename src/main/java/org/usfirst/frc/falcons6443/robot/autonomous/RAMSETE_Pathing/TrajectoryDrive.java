package org.usfirst.frc.falcons6443.robot.autonomous.RAMSETE_Pathing;
...
public class TrajectoryDrive{
    ...
    public void tankDriveVolts(double leftVolts, double rightVolts){
        drive.getLeftMotors().setVoltage(leftVolts);
        drive.getRightMotors().setVoltage(rightVolts);
    }
